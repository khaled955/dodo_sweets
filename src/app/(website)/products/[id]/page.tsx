...
import ProductDetailsClient from "./_components/product-details";
...
//     toast(t("common.addedToWishlist"), { description: cake?.Name, icon: "♥" });
//   }
...
//   /* Simulate multiple images — the API only provides one */
...
//               />
//               {hasDiscount && (
//                 <span className="absolute inst-s-4 top-4 rounded-full bg-primary px-3 py-1 text-xs font-bold text-primary-foreground">
//                   {t("product.sale")}
//                 </span>
//               )}
//             </div>
